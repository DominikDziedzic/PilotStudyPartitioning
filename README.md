...
```
The dataset consists of two IVs (i.e., "condition" and "training") and a DV ("final" answers). The length of the dataset is 45. Assignment to conditions was random, with 15 participants in the control condition, 13 in the unprimed condition, and 17 in the primed. Rough definitions of the conditions are as follow:
